  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'ejemplos',
        loadChildren: () =>
          import('@modules/ejemplos/ejemplos.module').then(
            m => m.EjemplosModule
          ),
      },
      {
      ...
      },
      {
        path: 'form-elements',
        loadChildren: () =>
          import('@modules/form-elements/form-elements.module').then(
      ...
      },
      {
        ...
        loadChildren: () =>
          import(
            '@modules/advanced-form-elements/advanced-form-elements.module'
